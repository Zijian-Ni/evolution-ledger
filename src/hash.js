/**
 * Isomorphic sync SHA-256 + uuid.
 * Browser WebCrypto is async, and ledger hashing must stay synchronous,
 * so we ship a compact sync implementation that matches node:crypto output.
 */
const K = [
